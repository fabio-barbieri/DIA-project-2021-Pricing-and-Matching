...
plt.hlines(config_4.OPT, 0, 365, linestyles="dashed", color = 'darkgreen')
xx = range(365)
...
plt.hlines(config_4.OPT * 365, 0, 365, linestyles="dashed", color = 'darkred')
xx = range(365)
...
plt.savefig(f"step4/plots/TS/TS_CumulativeRegret_{config_4.N_EXPS}e-{config_4.N_ARMS}a.png", dpi=200)
plt.show()
