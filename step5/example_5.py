...
plt.savefig(f"step5/plots/setting{config_5.SETTING}/ExpRew_set{config_5.SETTING}-{config_5.N_EXPS}e-{config_5.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step5/plots/setting{config_5.SETTING}/CumulativeExpRew_set{config_5.SETTING}-{config_5.N_EXPS}e-{config_5.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step5/plots/setting{config_5.SETTING}/DailyRegret_set{config_5.SETTING}-{config_5.N_EXPS}e-{config_5.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step5/plots/setting{config_5.SETTING}/CumulativeRegret_set{config_5.SETTING}-{config_5.N_EXPS}e-{config_5.N_ARMS}a.png", dpi=200)
plt.show()
