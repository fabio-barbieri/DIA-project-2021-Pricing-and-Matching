...
for e in tqdm(range(config_3.N_EXPS)):
    ...
    for t in range(config_3.T):
        ...
        for c_class in customer_arrivals:
            ...
            ts_learner.update(pulled_arm, reward1, c_class)
...
plt.savefig(f"step3/plots/TS/setting{config_3.SETTING}/TS_ExpRew_set{config_3.SETTING}-{config_3.N_EXPS}e-{config_3.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step3/plots/TS/setting{config_3.SETTING}/TS_CumulativeExpRew_set{config_3.SETTING}-{config_3.N_EXPS}e-{config_3.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step3/plots/TS/setting{config_3.SETTING}/TS_DailyRegret_set{config_3.SETTING}-{config_3.N_EXPS}e-{config_3.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step3/plots/TS/setting{config_3.SETTING}/TS_CumulativeRegret_set{config_3.SETTING}-{config_3.N_EXPS}e-{config_3.N_ARMS}a.png", dpi=200)
plt.show()