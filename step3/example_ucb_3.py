...
# plt.plot(np.mean(config_3.OPT - ucb_reward_per_experiment, axis=0), color='b')
...
# plt.ylabel("Cumulative Regret")
# plt.hlines(0, 0, 365, linestyles="dashed")
# plt.plot(np.sumsum(np.mean(config_3.OPT - ucb_reward_per_experiment, axis=0)), color='c')
