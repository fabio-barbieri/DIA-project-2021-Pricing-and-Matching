...
plt.savefig(f"step6/plots/setting{config_6.SETTING}/ExpRew_set{config_6.SETTING}-{config_6.N_EXPS}e-{config_6.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step6/plots/setting{config_6.SETTING}/CumulativeExpRew_set{config_6.SETTING}-{config_6.N_EXPS}e-{config_6.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step6/plots/setting{config_6.SETTING}/DailyRegret_set{config_6.SETTING}-{config_6.N_EXPS}e-{config_6.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step6/plots/setting{config_6.SETTING}/CumulativeRegret_set{config_6.SETTING}-{config_6.N_EXPS}e-{config_6.N_ARMS}a.png", dpi=200)
plt.show()
