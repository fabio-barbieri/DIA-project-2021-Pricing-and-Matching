...
plt.hlines(config_6.OPT, 0, 365, linestyles="dashed", colors='black')
xx = range(365)
...
plt.savefig(f"step6/plots/setting{config_6.SETTING}/ExpRew_set{config_6.SETTING}-{config_6.N_EXPS}e-{config_6.N_ARMS_1}a1-{config_6.N_ARMS_2}a2.png", dpi=200)
plt.show()

plt.figure(1, figsize=(12, 7), dpi=200.0)
plt.xlabel("t")
plt.ylabel("Cumulative Expected Reward")
plt.hlines(config_6.OPT * 365, 0, 365, linestyles="dashed", colors='black')
xx = range(365)
...
plt.savefig(f"step6/plots/setting{config_6.SETTING}/CumulativeExpRew_set{config_6.SETTING}-{config_6.N_EXPS}e-{config_6.N_ARMS_1}a1-{config_6.N_ARMS_2}a2.png", dpi=200)
plt.show()
...
plt.savefig(f"step6/plots/setting{config_6.SETTING}/DailyRegret_set{config_6.SETTING}-{config_6.N_EXPS}e-{config_6.N_ARMS_1}a1-{config_6.N_ARMS_2}a2.png", dpi=200)
plt.show()
...
plt.savefig(f"step6/plots/setting{config_6.SETTING}/CumulativeRegret_set{config_6.SETTING}-{config_6.N_EXPS}e-{config_6.N_ARMS_1}a1-{config_6.N_ARMS_2}a2.png", dpi=200)
plt.show()