...
plt.savefig(f"step8/plots/ExpRew_{config_8.N_EXPS}e-{config_8.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step8/plots/CumulativeExpRew_{config_8.N_EXPS}e-{config_8.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step8/plots/DailyRegret_{config_8.N_EXPS}e-{config_8.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step8/plots/CumulativeRegret_{config_8.N_EXPS}e-{config_8.N_ARMS}a.png", dpi=200)
plt.show()
