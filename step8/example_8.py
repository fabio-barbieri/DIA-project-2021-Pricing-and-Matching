...
plt.step([0, 91, 182, 273, 365], np.insert(config_8.OPT, -1, config_8.OPT[-1]), where='post', linestyle='dashed', color = 'darkgreen')
...
plt.savefig(f"step8/plots/setting{config_8.SETTING}/ExpRew_set{config_8.SETTING}-{config_8.N_EXPS}e-{config_8.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step8/plots/setting{config_8.SETTING}/CumulativeExpRew_set{config_8.SETTING}-{config_8.N_EXPS}e-{config_8.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step8/plots/setting{config_8.SETTING}/DailyRegret_set{config_8.SETTING}-{config_8.N_EXPS}e-{config_8.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step8/plots/setting{config_8.SETTING}/CumulativeRegret_set{config_8.SETTING}-{config_8.N_EXPS}e-{config_8.N_ARMS}a.png", dpi=200)
plt.show()
