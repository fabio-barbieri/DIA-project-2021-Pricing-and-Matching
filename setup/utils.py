...
# Opt for the weighted averages for step 3 and 4 ---------------------------------------------------------------
def opt_weighted_averages(margins_1, num_customers, cr1, matching, margins_2, cr2, step):
    if step == 3:
        tot_customers = 1
    elif step == 4:
    ...
    for i, arm in enumerate(margins_1):  # For every price_1
        ...
        for j, n_customers in enumerate(num_customers):  # For every customer class
            ...
            margin1 = arm
            promo_assigment_prob = matching[j, :] / n_customers * tot_customers
...
def profit(i, cr1, margin1, cr2, margins2, matching, num_customers):
...
if __name__ == '__main__':
    ...
    known_profits = np.array([profit(i, cr1, m1, cr2, margins_2, matching, num_customers) for i, m1 in enumerate(margins_1)])
    ...
    opt4 = opt_weighted_averages(margins_1, num_customers, cr1, matching, margins_2, cr2, step=4)
    step4['opt'] = opt4
