...
plt.savefig(f"step7/plots/ExpRew_{config_7.N_EXPS}e-{config_7.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step7/plots/CumulativeExpRew_{config_7.N_EXPS}e-{config_7.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step7/plots/DailyRegret_{config_7.N_EXPS}e-{config_7.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step7/plots/CumulativeRegret_{config_7.N_EXPS}e-{config_7.N_ARMS}a.png", dpi=200)
plt.show()
