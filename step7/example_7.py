...
plt.step([0, 91, 182, 273, 365], np.insert(config_7.OPT, -1, config_7.OPT[-1]), where='post', linestyle='dashed', color = 'darkgreen')
...
plt.savefig(f"step7/plots/setting{config_7.SETTING}/ExpRew_set{config_7.SETTING}-{config_7.N_EXPS}e-{config_7.N_ARMS}a.png", dpi=200)
plt.show()

plt.figure(1, figsize=(12, 7), dpi=200.0)
plt.xlabel("t")
plt.ylabel("Cumulative Expected Reward")
plt.hlines(opt, 0, 365, linestyles="dashed", color = 'darkred')
xx = range(365)
...
plt.savefig(f"step7/plots/setting{config_7.SETTING}/CumulativeExpRew_set{config_7.SETTING}-{config_7.N_EXPS}e-{config_7.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step7/plots/setting{config_7.SETTING}/DailyRegret_set{config_7.SETTING}-{config_7.N_EXPS}e-{config_7.N_ARMS}a.png", dpi=200)
plt.show()
...
plt.savefig(f"step7/plots/setting{config_7.SETTING}/CumulativeRegret_set{config_7.SETTING}-{config_7.N_EXPS}e-{config_7.N_ARMS}a.png", dpi=200)
plt.show()
