...
class Learner_7:
    def __init__(self, n_arms_1, n_arms_2, tot_customers, promo_prob, sd_customers, margins_1, margins_2, window_size):
    ...
    def build_matrix(self, idx1, idx2):
        ...
        profit =  cr1 * (self.margins_1[idx1] + cr2 * self.margins_2[idx2])
